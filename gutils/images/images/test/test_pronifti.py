# -*- coding: utf-8 -*-
""" gutils/images/images/test/test_pronifti """

import os
import unittest

from gutils.constants import TEST_IMAGES_PATH
from gutils.images.images import ProNIfTI
from gutils.settings import QUICK_TESTS
